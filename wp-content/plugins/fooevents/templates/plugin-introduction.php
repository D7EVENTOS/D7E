...
<div class='woocommerce-events-help'>
	...
	<div class="clear"></div> 
		...
		<div class="woocommerce-events-extension">
				...
				<span class='install-status installed'><?php echo esc_attr( 'Installed', 'woocommerce-events' ); ?></span> | 
		...
		">    
			...
			<?php
			if ( is_plugin_active( 'fooevents_bookings/fooevents-bookings.php' ) || is_plugin_active_for_network( 'fooevents_bookings/fooevents-bookings.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-bookings/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_bookings/fooevents-bookings.php' ) ) {
					...
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-bookings/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">    
			...
			<?php
			if ( is_plugin_active( 'fooevents_custom_attendee_fields/fooevents-custom-attendee-fields.php' ) || is_plugin_active_for_network( 'fooevents_custom_attendee_fields/fooevents-custom-attendee-fields.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-custom-attendee-fields/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_custom_attendee_fields/fooevents-custom-attendee-fields.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-custom-attendee-fields/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">    
			...
			<?php
			if ( is_plugin_active( 'fooevents_seating/fooevents-seating.php' ) || is_plugin_active_for_network( 'fooevents_seating/fooevents-seating.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-seating/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_seating/fooevents-seating.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-seating/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">    
			...
			<?php
			if ( is_plugin_active( 'fooevents_multi_day/fooevents-multi-day.php' ) || is_plugin_active_for_network( 'fooevents_multi_day/fooevents-multi-day.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-multi-day/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_multi_day/fooevents-multi-day.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-multi-day/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">
			...
			<?php
			if ( is_plugin_active( 'fooevents_pdf_tickets/fooevents-pdf-tickets.php' ) || is_plugin_active_for_network( 'fooevents_pdf_tickets/fooevents-pdf-tickets.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-pdf-tickets/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_pdf_tickets/fooevents-pdf-tickets.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-pdf-tickets/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">
			...
			<?php
			if ( is_plugin_active( 'fooevents-calendar/fooevents-calendar.php' ) || is_plugin_active_for_network( 'fooevents-calendar/fooevents-calendar.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-calendar/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents-calendar/fooevents-calendar.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-calendar/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
		...
		">
			...
			<?php
			if ( is_plugin_active( 'fooevents_express_check_in/fooevents-express-check_in.php' ) || is_plugin_active_for_network( 'fooevents_express_check_in/fooevents-express-check_in.php' ) ) {
				echo "<span class='install-status installed'>" . esc_attr( 'Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-express-check-in/' target='new'>" . esc_attr( 'Plugin Details', 'woocommerce-events' ) . '</a>';
			} else {
				if ( file_exists( ABSPATH . 'wp-content/plugins/fooevents_express_check_in/fooevents-express-check_in.php' ) ) {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Deactivated', 'woocommerce-events' ) . '</span>';
				} else {
					echo "<span class='install-status notinstalled'>" . esc_attr( 'Not Installed', 'woocommerce-events' ) . "</span> | <a href='https://www.fooevents.com/products/fooevents-express-check-in/' target='new'>" . esc_attr( 'Get Plugin', 'woocommerce-events' ) . '</a>';
				}
			}
			?>
