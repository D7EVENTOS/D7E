	...
	<div class="fooevents_printing_container">
		<div class="fooevents_printing_container_inner" id="fooevents_printing_container_inner_left">
			...
			<p class="form-field">
				...
				<input type="number" min="1" max="3" id="WooCommercePrintTicketNrColumns" name="WooCommercePrintTicketNrColumns" value="<?php echo ( empty( $woocommerce_print_ticket_nr_columns ) ) ? '3' : esc_attr( $woocommerce_print_ticket_nr_columns ); ?>" >
			...
			<p class="form-field">
				...
				<input type="number" min="1" max="3" id="WooCommercePrintTicketNrRows" name="WooCommercePrintTicketNrRows" value="<?php echo ( empty( $woocommerce_print_ticket_nr_rows ) ) ? '3' : esc_attr( $woocommerce_print_ticket_nr_rows ); ?>" >
