...
class FooEvents_Orders_Helper {
	...
	public function resend_order_ticket() {
		...
		$to = '';
		if ( isset( $_POST['WooCommerceEventsResendOrderTicketEmail'] ) ) {

			$to = sanitize_text_field( wp_unslash( $_POST['WooCommerceEventsResendOrderTicketEmail'] ) );
	 ...
	 * @return array
	 */
	private function process_order_tickets_for_display( $woocommerce_events_order_tickets ) {
