...
class FooEvents_Mail_Helper {
	 ...
	 */
	public function parse_ticket_template( $template, $ticket, $preview_ticket = false ) {
		...
		if ( $preview_ticket ) {
			...
			$barcodeURL = $this->config->event_plugin_url . 'images/barcode.png';
			...
			$barcodeURL = $this->config->barcode_url . $ticket['barcodeFileName'] . '.png';

		}

		$locationIcon = $theme_packs_url . $theme_name . '/images/location.jpg';
		$timeIcon     = $theme_packs_url . $theme_name . '/images/time.jpg';
		$ticketIcon   = $theme_packs_url . $theme_name . '/images/ticket.jpg';
