		...
		foreach ( $events as $event => $tickets ) {
			...
			if ( $capture_attendees || $capture_attendee_other || $seating_chart || $custom_fields || $booking_options ) {
				...
				foreach ( $tickets as $ticket ) {
					...
					if ( empty( $woocommerce_events_copy_override ) || 1 == $woocommerce_events_copy_override ) {
		...
		foreach ( $events as $event => $tickets ) {
			...
			foreach ( $tickets as $ticket ) {
				...
				if ( 'on' === $woocommerce_events_capture_attendee_details ) {
					...
					if ( ! isset( $_POST[ $ticket['product_id'] . '_attendee_' . $x . '__' . $y ] ) || empty( $_POST[ $ticket['product_id'] . '_attendee_' . $x . '__' . $y ] ) ) {
					...
					if ( ! isset( $_POST[ $ticket['product_id'] . '_attendeelastname_' . $x . '__' . $y ] ) || empty( $_POST[ $ticket['product_id'] . '_attendeelastname_' . $x . '__' . $y ] ) ) {
				...
				if ( ( 'on' === $woocommerce_events_capture_attendee_details && '' === $woocommerce_events_capture_attendee_email ) || 'on' === $woocommerce_events_capture_attendee_email ) {
					...
					$attendee_email = '';
					if ( isset( $_POST[ $ticket['product_id'] . '_attendeeemail_' . $x . '__' . $y ] ) ) {

						$attendee_email = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendeeemail_' . $x . '__' . $y ] ) );
				...
				if ( 'on' === $woocommerce_events_capture_attendee_telephone ) {
					if ( isset( $_POST[ $ticket['product_id'] . '_attendeetelephone_' . $x . '__' . $y ] ) && empty( $_POST[ $ticket['product_id'] . '_attendeetelephone_' . $x . '__' . $y ] ) ) {
				...
				if ( 'on' === $woocommerce_events_capture_attendee_company ) {
					if ( ! isset( $_POST[ $ticket['product_id'] . '_attendeecompany_' . $x . '__' . $y ] ) || empty( $_POST[ $ticket['product_id'] . '_attendeecompany_' . $x . '__' . $y ] ) ) {
				...
				if ( 'on' === $woocommerce_events_capture_attendee_designation ) {
					if ( ! isset( $_POST[ $ticket['product_id'] . '_attendeedesignation_' . $x . '__' . $y ] ) || empty( $_POST[ $ticket['product_id'] . '_attendeedesignation_' . $x . '__' . $y ] ) ) {
			...
			foreach ( $tickets as $ticket ) {
				...
				if ( 'on' === $woocommerce_events_capture_attendee_details || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_details && '' !== $woocommerce_events_pos_attendee_details ) || 'on' === $woocommerce_events_capture_attendee_email || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_email && '' !== $woocommerce_events_pos_attendee_email ) ) {
					...
					if ( 'on' === $woocommerce_events_capture_attendee_details || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_details && '' !== $woocommerce_events_pos_attendee_details ) ) {
						...
						if ( isset( $_POST[ $ticket['product_id'] . '_attendee_' . $x . '__' . $y ] ) ) {

							$attendee_name = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendee_' . $x . '__' . $y ] ) );

						}

						if ( isset( $_POST[ $ticket['product_id'] . '_attendeelastname_' . $x . '__' . $y ] ) ) {

							$attendee_last_name = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendeelastname_' . $x . '__' . $y ] ) );
				...
				if ( ( 'on' === $woocommerce_events_capture_attendee_telephone || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_telephone && '' !== $woocommerce_events_pos_attendee_telephone ) ) && isset( $_POST[ $ticket['product_id'] . '_attendeetelephone_' . $x . '__' . $y ] ) ) {

					$attendee_telephone = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendeetelephone_' . $x . '__' . $y ] ) );

				}

				if ( ( 'on' === $woocommerce_events_capture_attendee_company || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_company && '' !== $woocommerce_events_pos_attendee_company ) ) && isset( $_POST[ $ticket['product_id'] . '_attendeecompany_' . $x . '__' . $y ] ) ) {

					$attendee_company = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendeecompany_' . $x . '__' . $y ] ) );

				}

				if ( ( 'on' === $woocommerce_events_capture_attendee_designation || ( $pos_order && 'hide' !== $woocommerce_events_pos_attendee_designation && '' !== $woocommerce_events_pos_attendee_designation ) ) && isset( $_POST[ $ticket['product_id'] . '_attendeedesignation_' . $x . '__' . $y ] ) ) {

					$attendee_designation = sanitize_text_field( wp_unslash( $_POST[ $ticket['product_id'] . '_attendeedesignation_' . $x . '__' . $y ] ) );
